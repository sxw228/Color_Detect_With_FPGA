#Rst
set_property -dict {PACKAGE_PIN C3 IOSTANDARD LVCMOS33} [get_ports {i_key[0]}]
set_property -dict {PACKAGE_PIN M4 IOSTANDARD LVCMOS33} [get_ports {i_key[1]}]
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports i_rst]

#rgb led

set_property -dict {PACKAGE_PIN N11 IOSTANDARD LVCMOS33} [get_ports {RGB_LED_IO}]
